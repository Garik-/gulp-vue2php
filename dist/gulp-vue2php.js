(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["gulp-vue2php"] = factory();
	else
		root["gulp-vue2php"] = factory();
})(this, function() {
...
var template = '<a v-if="row.name" href="#">test</a>';
(0, _htmlParser.parseHTML)(template, {
    warn: warn,
    expectHTML: true,
    isUnaryTag: _util.isUnaryTag,
    canBeLeftOpenTag: _util.canBeLeftOpenTag,
